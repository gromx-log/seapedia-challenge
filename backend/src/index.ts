...
import driverJobRoutes from "./routes/driverJobRoutes";
import adminSystemClockRoutes from "./routes/adminSystemClockRoutes";
...
app.use("/api/driver/jobs", driverJobRoutes);
app.use("/api/admin/system-clock", adminSystemClockRoutes);
